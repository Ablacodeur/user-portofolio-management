    ...
    <Box sx={{ position: 'relative' }}>
      ...
      ></Box>
        ...
        <Link to={"/profile"}>
          ...
          >
            {/* ✅ Spinner visible au-dessus de l’image */}
            {!isImageLoaded && (
              <CircularProgress
                size="lg"
                sx={{
            ...
            {imagePath && (
              <img
                ...
                onError={() => setIsImageLoaded(true)} // évite le spinner infini
                loading="lazy"
                style={{
                  width: '100%',
                  height: '100%',
                  objectFit: 'cover',
                  opacity: isImageLoaded ? 1 : 0, // effet fondu
      ...
      >
        ...
        <h1 style={{ fontSize: '40px', padding: '0px' }}>
          {profile.sudoname}
          <br />
        ...
        <Box sx={{ marginBottom: '50px', width: '100%' }}>
          {projectList.map((project, id) => (
            <React.Fragment key={id}>
              ...
              >
                {/* ✅ Lazy loading des images des projets */}
